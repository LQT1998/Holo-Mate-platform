...
@pytest.mark.asyncio
async def test_user_data_erasure_flow(client: AsyncClient, db_session: Session, authenticated_user_headers: dict):
    """
    ...
    delete_response = await client.post("/users/me/delete", json=delete_payload, headers=authenticated_user_headers)
    ...
    profile_response = await client.get("/users/me", headers=authenticated_user_headers)
